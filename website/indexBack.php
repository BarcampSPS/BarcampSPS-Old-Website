  <?php 
  $mysqli = new mysqli("127.0.0.1", "root", "asdf1234%", "barcampsps");
  ...
  //echo 'yes';
   ...
   else
   {
    ...
    header("Location: " . $_SERVER['http://dev.barcampsps.com/barcamp-2/index.php']);
                        ...
                        <div class="entry">
                          ...
                          <div class="">
                              <table style="border-style:none;">
                               <tr style="border-style:none;">
                                <td style="border-style:none; width:300px;"> 
                                 <center><img src="images/logo_unitec.png" width="300" height="300"></center>
                               </td>
                               <td style="border-style:none; width:300px;"> 
                                 <center><img src="images/rosalila_logo.png" width="300" height="300"></center>
                               </td>
                               <td style="border-style:none; width:300px;"> 
                                 <center><img src="images/logo_probit.jpg" width="300" height="300"></center>
                               </td>
